...
def evaluation(city, exp_path, model_name, start_time):
    ...
    # load adj
    edge_index = np.load("/home/harddisk/jxh/trajectory/JGRM/dataset/{}/line_graph_edge_idx.npy".format(city))
    ...
    test_node_data = pickle.load(
        open('/home/harddisk/jxh/trajectory/JGRM/dataset/{}/{}_1101_1115_data_sample10w.pkl'.format(city, city), 'rb')) # data_seq_evaluation.pkl
    ...
    test_seq_data = pickle.load(
        open('/home/harddisk/jxh/trajectory/JGRM/dataset/{}/{}_1101_1115_data_seq_evaluation.pkl'.format(city, city),
             'rb'))
