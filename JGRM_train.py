...
def train(config):
    ...
    init_road_emb = torch.load('/home/harddisk/jxh/trajectory/JGRM/dataset/chengdu/init_w2v_road_emb.pt', map_location='cuda:{}'.format(dev_id))
...
if __name__ == '__main__':
    config = json.load(open('/home/harddisk/jxh/trajectory/JGRM/config/chengdu.json', 'r'))
    train(config)
